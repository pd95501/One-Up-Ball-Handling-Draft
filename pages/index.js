      ...
      <main className="main" role="main">
        ...
        <section className="hero container">
          <div className="hero__text">
            ...
            <h1>
              <span className="accent">Train smarter.</span> Shoot better. <span className="glow">Score more.</span>
            </h1>
            <p className="lead">
              A modern system for players who want real in-game results—built on drills, data, and consistent coaching.
            </p>
            <div className="cta">
              <a className="btn" href="#programs">Explore Programs</a>
              <a className="btn btn--ghost" href="#articles">Read Articles</a>
            </div>
            <p className="tiny">Free preview • Mobile-friendly workouts • No credit card</p>
          </div>
        ...
        <section className="container brands" aria-label="Trusted by">
          ...
          <ul>
            <li>High School Programs</li><li>AAU Teams</li><li>College Recruits</li><li>Coaches</li>
          </ul>
        </section>
        ...
        <section id="programs" className="container section">
          <header className="section__header">
            ...
            <p className="muted">Structured, progressive plans you can start today.</p>
          </header>
          <div className="grid-3">
            <article className="card">
              <h3>27-Day Shooting System</h3>
              <p className="muted">Daily reps, form fixes, and tracking to increase your % from anywhere on the floor.</p>
              <a className="btn btn--block" href="#">Start Shooting</a>
            </article>
            <article className="card card--primary">
              <h3>Scoring System</h3>
              <p className="muted">Footwork, finishing, and reads to create separation and convert at the rim.</p>
              <a className="btn btn--block" href="#">Start Scoring</a>
            </article>
            <article className="card">
        ...
        <section id="features" className="container section features">
          <header className="section__header">
            ...
            <p className="muted">Short sessions • measurable progress • game-ready habits</p>
          </header>
          <div className="grid-3">
            <article className="feature">
              <div className="feature__icon" aria-hidden="true">🏀</div>
              <h3>Game-speed drills</h3>
              <p>Built to transfer—footwork, timing, and reads that show up on game night.</p>
            </article>
            <article className="feature">
              <div className="feature__icon" aria-hidden="true">📈</div>
              <h3>Track your reps</h3>
              <p>Simple tracking so you can see makes, attempts, and streaks improve.</p>
            </article>
            <article className="feature">
              <div className="feature__icon" aria-hidden="true">🎧</div>
              <h3>Coach in your pocket</h3>
              <p>Clear videos and cues—no fluff. Train anywhere with your phone.</p>
            </article>
          </div>
        </section>
        ...
        <section id="articles" className="container section">
          <header className="section__header">
            ...
            <p className="muted">Drills, workouts, and tips from our coaches.</p>
          </header>
          <div className="grid-3">
            <article className="post">
              <div className="post__thumb"></div>
              <h3>Form Fixes: Elbow In, Wrist Snap</h3>
              <p className="muted">3 quick cues that change your arc and accuracy.</p>
              <a className="btn btn--sm" href="#">Read</a>
            </article>
            <article className="post">
              <div className="post__thumb"></div>
              <h3>2-Dribble Pull-Up Timing</h3>
              <p className="muted">Footwork sequence for balance and rise.</p>
              <a className="btn btn--sm" href="#">Read</a>
            </article>
            <article className="post">
              <div className="post__thumb"></div>
              <h3>Beat The Hedge</h3>
              <p className="muted">Simple reads to punish hard hedges and switches.</p>
              <a className="btn btn--sm" href="#">Read</a>
            </article>
          </div>
        </section>
