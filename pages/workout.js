      ...
      <main className="main" role="main">
        ...
        <section className="hero container">
          <div className="hero__text">
            ...
            <p className="tiny">
              No credit card • No guess work• No trainer needed — just clear,
              game-ready drills.
            </p>
          </div>
        ...
        >
          <header className="section__header">
            <h2>Testimonials</h2>
            <p className="muted">
              Hear from athletes who has used the same drills built into this One Up AI Ball Handling Workout Tool.
            </p>
          </header>
          ...
          <div className="builder-center">
            <article className="card card--primary builder-card">
              ...
              <p className="muted">
                ...
                AI and shaped by over 20 years of training experience.
                No guess work — just clear
