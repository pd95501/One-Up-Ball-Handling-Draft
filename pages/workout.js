      ...
      <main className="main" role="main">
        ...
        <section className="hero container">
          <div className="hero__text">
            ...
            <p className="lead">
              Gain access to 20+ years of One Up training experience with our new One Up AI Ball Handling program that generates custom 30-minute ball-handling workouts based on your goals — completely free.
            </p>
            <div className="cta">
        ...
        <section id="workouts" className="container section">
          <header className="section__header">
            ...
            <p className="muted">
              ...
              design a focused 30-minute ball-handling workout built for your
              game.
            </p>
          </header>
          ...
          <div className="builder-center">
            <article className="card card--primary builder-card">
              ...
              <p className="muted">
                Get a customized 30-minute ball-handling workout generated by
        ...
        <section id="benefits" className="container section features">
          ...
          <div className="grid-3">
            ...
            <article className="feature card">
              ...
              <p>
                Your custom 30-minute session is generated using the proven
