      ...
      <main className="main" role="main">
        ...
        <section className="hero container">
          <div className="hero__text">
            <p className="pretitle">Free AI Ball-Handling Workout Tool</p>
            <h1>
              Smarter Training.<br />
            ...
            <p className="lead">
              Gain access to 20+ years of training experience with our new One Up AI Ball Handling Tool that generates custom 10-minute ball-handling workouts based on your goals — completely free.
            </p>
            <div className="cta">
            ...
            <p className="tiny">
              No credit card • No hassel • Just Free Workouts — Period,
        ...
        >
          <header className="section__header">
            ...
            <p className="muted">
              ...
              AI Ball Handling tool works and how to get the most out of it.
            </p>
          </header>
          ...
          <div className="video-center">
            <div className="video-wrapper">
              <iframe
                ...
                title="Elite Skills Trainer explaining the AI workout tool"
                frameBorder="0"
        ...
        <section id="workouts" className="container section">
          <header className="section__header">
            ...
            <p className="muted">
              Answer a few questions and let the One Up AI Ball Handling tool
          ...
          <div className="builder-center">
            <article className="card card--primary builder-card">
              ...
              <p className="muted">
                ...
                the One Up AI Ball Handling tool which is shaped by over 20 years
                of training experience. No guess work — just clear
                drills, reps, and workout plans.
              </p>
              <p className="tiny">
        ...
        <section id="benefits" className="container section features">
          <header className="section__header">
            ...
            <p className="muted">
              Powered by over 20 years of training experience
              and the proven curriculum used for thousands of athletes.
            </p>
          </header>
          ...
          <div className="grid-3">
            ...
            <article className="feature card">
              ...
              <p>
                Your custom 10-minute session is generated using AI and Elite Skills Trainer, Paris Davis, proven
                ball-handling methods.
                Now delivered instantly through our One Up AI Ball
                Handling program.
              </p>
            </article>
